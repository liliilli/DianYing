...
template <typename TType>
const DVector3<typename DArea3D<TType, std::enable_if_t<kIsRealType<TType>>>::TValueType>& 
...
template <typename TType>
DVector3<typename DArea3D<TType, std::enable_if_t<kIsRealType<TType>>>::TValueType> 
DArea3D<TType, typename std::enable_if<kIsRealType<TType>>::type>
...
template <typename TType>
typename DArea3D<TType, std::enable_if_t<kIsRealType<TType>>>::TValueType 
DArea3D<TType, typename std::enable_if<kIsRealType<TType>>::type>
