...
DVector4<TType, std::enable_if_t<kIsRealType<TType>>>
...
template <typename TType>
typename DVector4<TType, std::enable_if_t<kIsRealType<TType>>>::TValueType& 
DVector4<TType, std::enable_if_t<kIsRealType<TType>>>
...
template <typename TType>
const typename DVector4<TType, std::enable_if_t<kIsRealType<TType>>>::TValueType& 
DVector4<TType, std::enable_if_t<kIsRealType<TType>>>
...
template <typename TType>
TReal DVector4<TType, std::enable_if_t<kIsRealType<TType>>>
...
template <typename TType>
bool DVector4<TType, std::enable_if_t<kIsRealType<TType>>>
::HasNaN() const noexcept
{
  return std::isnan(this->X) || std::isnan(this->Y) 
      || std::isnan(this->Z) || std::isnan(this->W);
}
...
::HasInfinity() const noexcept
{
  return std::isinf(this->X) || std::isinf(this->Y) 
      || std::isinf(this->Z) || std::isinf(this->W);
}
...
::HasOnlyNormal() const noexcept
{
  return std::isnormal(this->X) && std::isnormal(this->Y) 
      && std::isnormal(this->Z) && std::isnormal(this->W);
}
