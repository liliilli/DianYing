...
template <typename TType>
typename DQuat<TType>::TValueType& 
DQuat<TType>::operator[](TIndex index) 
{
  switch (index)
  {
...
template <typename TType>
const typename DQuat<TType>::TValueType& 
DQuat<TType>::operator[](TIndex index) const
{
  switch (index)
  {
  case 0: return this->mX;
...
template <typename TType>
DMatrix3<typename DQuat<TType>::TValueType> 
DQuat<TType>::ToMatrix3() const noexcept
{
...
template <typename TType>
DMatrix4<typename DQuat<TType>::TValueType> 
DQuat<TType>::ToMatrix4() const noexcept
{
...
template <typename TType>
DQuat<TType> DQuat<TType>::Inverse() const
{
  // Get conjugate matrix. 
  const auto conjugate = DQuat<TType>{this->mW, -this->mX, -this->mY, -this->mZ};
  const auto dot = this->mX * this->mX + this->mY * this->mY + this->mZ * this->mZ + this->mW * this->mW;
...
template<typename TType>
DVector3<TType> DQuat<TType>::ToDegrees() const noexcept
{
  return this->ToRadians() * kToDegree<TType>;
}

template<typename TType>
DVector3<TType> DQuat<TType>::ToRadians() const noexcept
{
...
template<typename TType>
void DQuat<TType>::AddAngle(const DVector3<TValueType>& angles, bool isDegree)
{
  if (isDegree == true)
  {
...
template<typename TType>
void DQuat<TType>::AddAngle(const DQuat<TValueType>& quaternion)
{
...
template<typename TType>
void DQuat<TType>::AddAngle(EAxis axis, TValueType iAngle, bool isDegree)
{
  auto angle = iAngle;
  if (isDegree == true)
  {
...
template<typename TType>
void DQuat<TType>::SetAngle(const DVector3<TValueType>& eulerAngles, bool isDegree)
{
...
template <typename TType>
bool DQuat<TType>::HasNaN() const noexcept
{
...
template <typename TType>
bool DQuat<TType>::HasInfinity() const noexcept
{
...
template <typename TType>
bool DQuat<TType>::HasOnlyNormal() const noexcept
{
...
template <typename TType>
const typename DQuat<TType>::TValueType* 
DQuat<TType>::Data() const noexcept
{
  return &this->mX;
}
