...
FInformationModelAnimScrap::FInformationModelAnimScrap(_MIN_ const PDyModelAnimInstanceMetaInfo& metaInfo) :
...
const std::string& FInformationModelAnimScrap::GetSpecifierName() const noexcept
{
  return this->mSpecifierName;
}

DVec3 FInformationModelAnimScrap::GetInterpolatedScaling(_MIN_ TF32 iElapsedTime, _MIN_ TU32 iBoneIndex, _MIN_ bool iIsLooped) const
{
...
DQuat FInformationModelAnimScrap::GetInterpolatedRotation(_MIN_ TF32 iElapsedTime, _MIN_ TU32 iBoneIndex, _MIN_ bool iIsLooped) const
{
  const auto& refBone = this->mAnimation.mAnimationNodeList[iBoneIndex];
...
DVec3 FInformationModelAnimScrap::GetInterpolatedPosition(_MIN_ TF32 iElapsedTime, _MIN_ TU32 iIdAnimNode, _MIN_ bool iIsLooped) const
{
...
FInformationModelAnimScrap::GetAnimNodeList() const noexcept
{
  return this->mAnimation.mAnimationNodeList;
}

TF32 FInformationModelAnimScrap::GetRateScale() const noexcept
{
