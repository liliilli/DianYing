...
FInformationModel::FInformationModel(_MIN_ const PDyModelInstanceMetaInfo& metaInfo) 
...
const std::vector<bool>& FInformationModel::GetInstancingFlags() const noexcept
{
