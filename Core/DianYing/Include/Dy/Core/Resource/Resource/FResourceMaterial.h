...
class FResourceMaterial final
{
public:
  FResourceMaterial(_MIN_ const FInformationMaterial& information);
  FResourceMaterial(_MIN_ const PDyMaterialInstanceMetaInfo& iInstanceInfo);
  ~FResourceMaterial() = default;
  ...
  /// @brief
  MDY_NODISCARD const FResourceShader* GetShaderResourcePtr() const noexcept
  {
