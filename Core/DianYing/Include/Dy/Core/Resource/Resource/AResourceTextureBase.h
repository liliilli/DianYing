...
{
public:
  AResourceTextureBase(const FInformationTexture& information);
  virtual ~AResourceTextureBase() = 0;
  ...
  TU32 GetTextureId() const noexcept;

  /// @brief Get texture type value.
  ETextureStyleType GetTextureType() const noexcept;
