#ifndef GUARD_DY_BUILTIN_MATERIAL_BtMtCheckerWorldPos_H
#define GUARD_DY_BUILTIN_MATERIAL_BtMtCheckerWorldPos_H
///
/// MIT License
...
#endif /// GUARD_DY_BUILTIN_MATERIAL_BtMtCheckerWorldPos_H