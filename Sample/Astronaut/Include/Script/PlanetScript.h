...
class PlanetScript final : public dy::AScriptResource, public dy::AActorCppScript
{
  MDY_REGISTER_RESOURCE_SCRIPT(PlanetScript, "ScriptPlanetScript")
public:
  ...
  static std::array<dy::DVec3, 4> mRotations;

private:
  dy::CSoundSource* mPtrSoundSource = nullptr;

  std::vector<std::pair<dy::DActorBinder, TU32>> mAstroidBinders;
  std::vector<std::pair<dy::DActorBinder, TU32>> mCrystalBinders;
};
