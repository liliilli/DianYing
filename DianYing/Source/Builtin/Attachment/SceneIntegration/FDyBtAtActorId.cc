...
void FDyBtAtActorId::ConstructBuffer(_MOUT_ PDyGlAttachmentInstanceMetaInfo& property) noexcept
{
  ...
  property.mBufferFormat  = EDyGlBufferDataInternalFormat::RED32UnsignedInt;
