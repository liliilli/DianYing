...
EDySuccess CDyTextureResource::pfInitializeResource(const CDyTextureInformation& textureInformation)
{
  ...
  DDyImageBinaryDataBuffer dataBuffer(textureInformation.GetInformation().mTexturePath);
  ...
  if (!textureInformation.GetInformation().mIsEnabledCustomedTextureParameter)
  {
