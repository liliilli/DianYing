...
bool RDyGlobalInstanceManager::IsGlobalInstanceExist(const char* iSpecifier)
{
...
ADyGlobalInstance* RDyGlobalInstanceManager::GetGlobalInstance(const char* iSpecifier) noexcept
{
  const auto hashVal = ::dy::hash::DyToCrc32Hash(iSpecifier);
...
ADyGlobalInstance* RDyGlobalInstanceManager::GetGlobalInstance(const std::string& iSpecifier) noexcept
{
