...
#include <Dy/Management/Type/Time/EDyTimeDay.h>
#include <Dy/Management/Type/Time/EDyTimeDST.h>
...
///
class DDyTimepoint final
{
public:
  DDyTimepoint(_MIN_ tm input);
...
private:
  ...
  EDyTimeDay mDayType = EDyTimeDay::Sunday;
  EDyTimeDST mIsDst   = EDyTimeDST::NotAvailable;
};
