...
///
/// @struct DDyMeshCompressedBuffer
/// @brief Compressed mesh information buffer.
///
struct DDyMeshCompressedBuffer final
{
...
/// @brief Create `DDyMeshCompressedBuffer` information from `dyMesh` file.
MDY_NODISCARD DDyMeshCompressedBuffer 
DyCreateMeshBufferInfoFromDyMeshFile(_MIN_ const std::string& iFilePath);
