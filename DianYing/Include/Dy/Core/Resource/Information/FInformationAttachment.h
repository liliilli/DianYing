#ifndef GUARD_DY_CORE_RESOURCE_INFORMATION_FInformationAttachment_H
#define GUARD_DY_CORE_RESOURCE_INFORMATION_FInformationAttachment_H
///
/// MIT License
...
///
class FInformationAttachment final
{
public:
  MDY_ONLY_MOVEABLE_PROPERTIES_DEFAULT(FInformationAttachment);

  /// @brief Construct attachment information.
  FInformationAttachment(const PDyGlAttachmentInstanceMetaInfo& metaInfo);
  ~FInformationAttachment() = default;
...
#endif /// GUARD_DY_CORE_RESOURCE_INFORMATION_FInformationAttachment_H