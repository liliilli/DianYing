...
private:
  ...
  TryRequireResource(_MIN_ const std::string& iSpecifier, _MIN_ const __IBinderBase* iPtrBinder)
  {
  ...
  (_MIN_ const std::string& iSpecifier, _MIN_ const __IBinderBase* iPtrBinder);
  ...
  template <EResourceType TType>
  MDY_NODISCARD static EDySuccess
  TryDetachResource(_MIN_ const std::string& iSpecifier, _MIN_ const __IBinderBase* iPtrBinder)
  {
  ...
  TryRequireInformation(_MIN_ const std::string& iSpecifier, _MIN_ const __IBinderBase* iPtrBinder)
  {
    if constexpr (TType == EResourceType::GLShader)     
  ...
  template <EResourceType TType>
  MDY_NODISCARD static EDySuccess
  TryDetachInformation(_MIN_ const std::string& iSpecifier, _MIN_ const __IBinderBase* iPtrBinder)
  {
