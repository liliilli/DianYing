...
/// @class LDyScript
/// @brief
/// Lua script frame for CDyScript.
///
class LDyScript
{
public:
  LDyScript(sol::this_state L) :
      mCustomizedInitiate(sol::make_reference<sol::function>(L.lua_state(), &LDyScript::Initiate)),
      mCustomizedStart(sol::make_reference<sol::function>(L.lua_state(), &LDyScript::Start)),
      mCustomizedUpdate(sol::make_reference<sol::function>(L.lua_state(), &LDyScript::Update)),
      mCustomizedDestroy(sol::make_reference<sol::function>(L.lua_state(), &LDyScript::Destroy)),
      mCustomizedOnEnabled(sol::make_reference<sol::function>(L.lua_state(), &LDyScript::OnEnabled)),
      mCustomizedOnDisabled(sol::make_reference<sol::function>(L.lua_state(), &LDyScript::OnDisabled))
  {}
