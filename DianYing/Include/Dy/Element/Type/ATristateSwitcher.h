...
/// @class ATristateSwitcher
/// @brief Helper type for moduling 3-way state bool mechanism between hierarchical tree.
class ATristateSwitcher 
{
public:
  ATristateSwitcher() = default;
  ATristateSwitcher(const ATristateSwitcher&) = default;
  ATristateSwitcher& operator=(const ATristateSwitcher&) = default;
  ATristateSwitcher(ATristateSwitcher&&) = default;
  ATristateSwitcher& operator=(ATristateSwitcher&&) = default;
  virtual ~ATristateSwitcher() = default;
