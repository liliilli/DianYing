...
class FWidgetText final : public AWidgetObject, public IInitializeHelper<PDyMetaWidgetTextDescriptor>
{
  MDY_SET_CRC32_HASH_WITH_TYPE(FWidgetText);
  MDY_SET_TYPEMATCH_FUNCTION(AWidgetObject, FWidgetText);
  MDY_ONLY_MOVEABLE_PROPERTIES_DEFAULT(FWidgetText);
public:
  ...
  FWidgetText() : mRenderer{*this} {};
  virtual ~FWidgetText()  = default;
