...
struct DDyVectorInt4 final {
  ...
  DDyVectorInt4(_MIN_ const TI32 x, _MIN_ const TI32 y, _MIN_ const TI32 z, _MIN_ const TI32 w) noexcept :
      X{x}, Y{y}, Z{z}, W{w} {}
  explicit DDyVectorInt4(_MIN_ const TI32 value) noexcept :
      X{value}, Y{value}, Z{value}, W{value} {}
  explicit DDyVectorInt4(_MIN_ const DDyVector4& value) noexcept :
  ...
  DDyVectorInt4(const glm::ivec4& value) noexcept : X{value.x}, Y{value.y}, Z{value.z}, W{value.w} {}
  ...
  DDyVectorInt4& operator=(_MIN_ const glm::ivec4& value) noexcept
  {
    this->X = value.x;
    this->Y = value.y;
    this->Z = value.z;
...
#if defined(false)
  DDyVectorInt4(const DirectX::XMINT2& value) noexcept : X{value.x}, Y{value.y} {}
  DDyVectorInt4(DirectX::FXMVECTOR value) noexcept
  {
  ...
  DDyVectorInt4& operator=(const DirectX::XMFLOAT2& value) noexcept
  {
    this->X = value.x;
    this->Y = value.y;
    return *this;
  ...
  DDyVectorInt4& operator+=(_MIN_ const DDyVectorInt4& value) noexcept
  {
  ...
  DDyVectorInt4& operator*=(_MIN_ const TI32 value) noexcept
  {
...
void to_json  (_MINOUT_ nlohmann::json& j,    _MIN_ const DDyVectorInt4& p);
void from_json(_MIN_ const nlohmann::json& j, _MOUT_ DDyVectorInt4& p);
