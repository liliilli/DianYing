...
class FDyDialog final : public IDyGuiWinSingleton<FDyDialog, PDyGuiComponentDialogDescriptor>
{
  MDY_GUISINGLETON_PROPERTIES(FDyDialog);
  MDY_GUISINGLETON_DERIVED(FDyDialog, PDyGuiComponentDialogDescriptor);
public:
  /// Draw dialog.
