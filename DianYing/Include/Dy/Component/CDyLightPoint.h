...
public:
  ...
  CDyLightPoint(const CDyLightPoint&)            = delete;
  CDyLightPoint& operator=(const CDyLightPoint&) = delete;
  CDyLightPoint(CDyLightPoint&& instance)            noexcept = default;
  CDyLightPoint& operator=(CDyLightPoint&& instance) noexcept = default;

  MDY_SET_TYPEMATCH_FUNCTION(::dy::ADyGeneralBaseComponent, CDyLightPoint);
