...
public:
  ...
  virtual ~CDyLightDirectional() = default;
  ...
  CDyLightDirectional(const CDyLightDirectional&)                                 = delete;
  CDyLightDirectional& operator=(const CDyLightDirectional&)                      = delete;
  CDyLightDirectional(CDyLightDirectional&& instance)                   noexcept  = default;
  CDyLightDirectional& operator=(CDyLightDirectional&& instance)        noexcept  = default;

  MDY_SET_TYPEMATCH_FUNCTION(::dy::ADyGeneralBaseComponent, CDyLightDirectional);
